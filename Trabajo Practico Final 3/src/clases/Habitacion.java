...
public class Habitacion {
     ...
     * @param fechaEntrada La fecha en que entra 
     * @param fechaSalida La fecha en que sale
    ...
    public boolean comprobarFechas(Date fechaEntrada, Date fechaSalida) {
        ...
        for (Fecha fe : fechasOcupadas) {
                ...
                if (!fechaEntrada.before(fe.getFechaIn()) && !fechaSalida.after(fe.getFechaOut())) { // si ambas fechas de entrada y salida son iguales 
                    flag = false;
                }
        }
        return flag;
